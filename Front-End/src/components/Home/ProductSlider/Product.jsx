        ...
        <div className="flex flex-col items-center  gap-2 px-2 py-6 relative">
            ...
            <Link to={`/product/${_id}`} className="flex flex-col items-center text-center group">
                <div className="w-36 h-36">
                    <img draggable="false" className="w-full h-full object-contain hover:scale-110 ease-in-out duration-300" src={images[0].url} alt={name} />
                </div>
            ...
            <div className="flex flex-col gap-2 items-center">
                ...
                <span className="text-sm text-gray-500 font-medium flex gap-2 items-center">
                    <span className="text-xs px-1.5 py-0.5 bg-green-400 rounded-sm text-white flex items-center gap-0.5">{ratings.toFixed(1)} <StarIcon sx={{ fontSize: "14px" }} /></span>
            ...
            <span  className="hover:text-red-500 text-gray-300 absolute top-5 right-2 cursor-pointer"><FavoriteIcon sx={{ fontSize: "16px" }} /></span>
            {/* <!-- wishlist badge --> */}
