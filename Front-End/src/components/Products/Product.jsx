  ...
  return (
    <div className="flex flex-col items-start gap-2 px-4 py-6 relative hover:shadow-lg rounded-sm">
      ...
      <Link
        ...
        <h2 className="text-sm mt-4 group-hover:text-blue-600 text-left">
      ...
      <div className="flex items-center gap-2 mt-4">
        ...
        <button
          className="bg-blue-600 text-white  px-4 py-2 rounded-md text-xs font-medium transition-all duration-200"
          onClick={() => {
            // addToWishlistHandler();
          }}>
          Buy Now
