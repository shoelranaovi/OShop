                        ...
                        label={
                          <div className="flex items-center gap-4">
                            <img
                              draggable="false"
                              className="h-6 w-6 object-contain"
                              src="https://th.bing.com/th/id/OIP.fmRAstwuHqPpSGuEQE3rZgHaEJ?rs=1&pid=ImgDetMain"
                              alt="bkash Logo"
                            />
                            <span>Bkash</span>
                          </div>
                        ...
                        label={
                          <div className="flex items-center gap-4">
                            <img
                              draggable="false"
                              className="h-6 w-6 object-contain"
                              src="https://th.bing.com/th/id/R.7b64debd9ce54a17895824030c03ecd1?rik=ez9QOitLfY2poQ&pid=ImgRaw&r=0"
                              alt="COD Logo"
                            />
                            <span>COD</span>
                          </div>
