...
const Shipping = () => {
  ...
  console.log(address, city, country, state, pincode, phoneNo);
  const dispatch = useDispatch();
  const navigate = useNavigate();
            ...
            <Stepper activeStep={1}>
              <div className="w-full bg-white">
                <form
                  ...
                  <button
                    type="submit"
                    className="bg-orange-600 w-full sm:w-1/3 my-2 py-3.5 text-sm font-medium text-white shadow hover:shadow-lg rounded-sm uppercase outline-none">
