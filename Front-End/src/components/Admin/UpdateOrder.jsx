...
import { singleorder, updatedOrder } from "@/Redux/orderSlice";
...
const UpdateOrder = () => {
  ...
  const updateOrderSubmitHandler = (e) => {
    ...
    dispatch(updatedOrder({ id, formData })).then((data) => {
        ...
        <>
          {order && order.user && order.shippingInfo && (
            <div className="flex flex-col gap-4">
              <Link
                to="/admin/orders"
                className="ml-1 flex items-center gap-0 font-medium text-blue-600 uppercase">
              ...
              <div className="flex flex-col sm:flex-row bg-white shadow-lg rounded-lg min-w-full">
                ...
                <form className="flex flex-col gap-3 p-8">
                  ...
                  <button
                    ...
                    className="bg-orange-600 p-2.5 text-white font-medium rounded shadow hover:shadow-lg">
                    Update
                  </button>
                </form>
              </div>
