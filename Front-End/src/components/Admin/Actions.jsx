      ...
      <div className="flex justify-between items-center h-full gap-3">
        {editRoute !== "review" && (
          <Link
            ...
            className="text-blue-600 hover:bg-blue-200 w-10 h-10 flex justify-center items-center rounded-full bg-blue-100">
            <EditIcon />
          </Link>
        )}
        <button
          onClick={() => setOpen(true)}
          className="text-red-600 w-10 h-10 flex justify-center items-center hover:bg-red-200 p-1 rounded-full bg-red-100">
          <DeleteIcon />
        </button>
      </div>
